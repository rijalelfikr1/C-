#pragma checksum "D:\SEMV_MRO_Tracking\SEMV_MRO_Tracking\Views\Admin\MaterialStock.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "9f9736c1add4e9a247e062ab982ae4ccc25798b5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"9f9736c1add4e9a247e062ab982ae4ccc25798b5", @"/Views/Admin/MaterialStock.cshtml")]
...
#nullable disable
        ...
        $('#scanin_qty').keyup(function (e) {
            ...
            if (request_qty > parseFloat(total_purchase)) {
                ...
                console.log(""Safe"");
                $(""input[name=pu");
                WriteLiteral(@"rchase_qty]"").removeClass('bg-danger');
                $(""#comments"").show();
            }
        });
        ...
        $(""button[name='btn_submit_scanin']"").click(function () {
            ...
            if (parseFloat(request_qty) <= parseFloat(total_purchase)) {
                $.ajax({
                    ...
                    url: """);
#nullable restore
#line 292 "D:\SEMV_MRO_Tracking\SEMV_MRO_Tracking\Views\Admin\MaterialStock.cshtml"
        ...
        $(""button[name='btn_submit']"").click(function () {
            ...
            if (parseFloat(request_qty) + parseFloat(actual_qty) + parseFloat(total_purchase) <= parseFloat(max_qty)) {
                $.ajax({
                    ...
                    url: """);
#nullable restore
#line 370 "D:\SEMV_MRO_Tracking\SEMV_MRO_Tracking\Views\Admin\MaterialStock.cshtml"
